...
bp3_control bp3_control_data_1;
...
void bp3_get_deltaxy_mes_1(bp3_control* data){
    data->bp3_lev_control.delta_mes[0] = POSITION_RATIO_X*(eddy_current_sensor_read_x_voltage(EDDY_CURRENT_SENSOR_4_BASE_ADDR) * M_PER_VOLT) + GEO_CENTER_X;
    data->bp3_lev_control.delta_mes[1] = POSITION_RATIO_y*(eddy_current_sensor_read_y_voltage(EDDY_CURRENT_SENSOR_4_BASE_ADDR) * M_PER_VOLT) + GEO_CENTER_y;
}
...
bp3_control *init_bp3_1(void){
    //init regulators
    encoder_set_pulses_per_rev_bits(ENCODER_BP3_PPR_BITS);
    para_bp3 *BP3_PARA_1;
    
    BP3_PARA_1 = get_para_bp3_1();
    
    flag_enc = 0;
    bp3_control_data_1.bp3_lev_control.enable = 0;
    bp3_control_data_1.bp3_lev_control.para_levi_control.Ts = TS;
    bp3_control_data_1.bp3_lev_control.para_levi_control.ba = BP3_PARA_1->para_control.lev_ba;
    bp3_control_data_1.bp3_lev_control.para_levi_control.ka = BP3_PARA_1->para_control.lev_ka;

    bp3_control_data_1.bp3_lev_control.para_levi_control.para_PI.Ts = TS;
    bp3_control_data_1.bp3_lev_control.para_levi_control.para_PI.Ki = BP3_PARA_1->para_control.lev_pi_Ki;
    bp3_control_data_1.bp3_lev_control.para_levi_control.para_PI.Kp = BP3_PARA_1->para_control.lev_pi_Kp;

    bp3_control_data_1.bp3_lev_control.para_levi_control.para_lpf.Ts = TS;
    bp3_control_data_1.bp3_lev_control.para_levi_control.para_lpf.fs = BP3_PARA_1->para_control.lev_lpf_f;

    bp3_control_data_1.bp3_lev_control.para_levi_control.para_delta_lpf.Ts = TS;
    bp3_control_data_1.bp3_lev_control.para_levi_control.para_delta_lpf.fs = BP3_PARA_1->para_control.lev_delta_lpf_f;

    bp3_control_data_1.bp3_lev_control.para_levi_control.para_anti_wp.k = BP3_PARA_1->para_control.lev_antiwp_k;
    bp3_control_data_1.bp3_lev_control.para_levi_control.para_anti_wp.sat_high = BP3_PARA_1->para_control.lev_sat_high;
    bp3_control_data_1.bp3_lev_control.para_levi_control.para_anti_wp.sat_low = BP3_PARA_1->para_control.lev_sat_low;

    bp3_control_data_1.bp3_v_control.enable = 0;
    bp3_control_data_1.bp3_v_control.is_start = 0;
    bp3_control_data_1.bp3_v_control.para_velocity_control.wrm_max = BP3_PARA_1->para_machine.wrm_max;
    bp3_control_data_1.bp3_v_control.para_velocity_control.para_PI.Ts = TS;
    bp3_control_data_1.bp3_v_control.para_velocity_control.para_PI.Ki = BP3_PARA_1->para_control.v_pi_Ki;
    bp3_control_data_1.bp3_v_control.para_velocity_control.para_PI.Kp = BP3_PARA_1->para_control.v_pi_Kp;

    bp3_control_data_1.bp3_v_control.para_ob.Ts = TS;
    bp3_control_data_1.bp3_v_control.para_ob.Kj = 1.0/BP3_PARA_1->para_machine.J;
    bp3_control_data_1.bp3_v_control.para_ob.Kd = PI2*BP3_PARA_1->para_control.ob_theta_fd;
    bp3_control_data_1.bp3_v_control.para_ob.para_PI.Ts = TS;
    bp3_control_data_1.bp3_v_control.para_ob.para_PI.Kp = bp3_control_data_1.bp3_v_control.para_ob.Kd*BP3_PARA_1->para_machine.J*PI2*BP3_PARA_1->para_control.ob_theta_fp;
    bp3_control_data_1.bp3_v_control.para_ob.para_PI.Ki = bp3_control_data_1.bp3_v_control.para_ob.para_PI.Kp*PI2*BP3_PARA_1->para_control.ob_theta_fi;


    bp3_control_data_1.bp3_v_control.para_velocity_control.para_lpf.Ts = TS;
    bp3_control_data_1.bp3_v_control.para_velocity_control.para_lpf.fs = BP3_PARA_1->para_control.v_lpf_f;

    bp3_control_data_1.bp3_v_control.Idq0_ref[0] = BP3_PARA_1->para_machine.id_ref;
    bp3_control_data_1.bp3_v_control.wrm_ref = 0.0;
    bp3_control_data_1.bp3_v_control.wrm_ref_lpf = 0.0;
    bp3_control_data_1.bp3_v_control.Ts = TS;

    reset_states_3phase(&(bp3_control_data_1.bp3_lev_control.para_levi_control.state_1));
    reset_states_3phase(&(bp3_control_data_1.bp3_lev_control.para_levi_control.para_PI.state_1));
    reset_states_3phase(&(bp3_control_data_1.bp3_lev_control.para_levi_control.para_lpf.state_1));
    reset_states_3phase(&(bp3_control_data_1.bp3_lev_control.para_levi_control.para_delta_lpf.state_1));
    reset_states_3phase(&(bp3_control_data_1.bp3_v_control.para_velocity_control.para_PI.state_1));
    reset_states_3phase(&(bp3_control_data_1.bp3_v_control.para_velocity_control.para_lpf.state_1));
    bp3_control_data_1.bp3_lev_control.delta_mes_lpf[0] = 0.0;
    bp3_control_data_1.bp3_lev_control.delta_mes_lpf[1] = 0.0;
    bp3_control_data_1.bp3_lev_control.diff_state[0] = 0.0;
    bp3_control_data_1.bp3_lev_control.diff_state[1] = 0.0;
    
    bp3_control_data_1.bp3_v_control.CFO_state =  0.0;
    bp3_control_data_1.bp3_v_control.time_pre =  0;
    bp3_control_data_1.bp3_v_control.theta_rm_mes =  0.0;
    bp3_control_data_1.bp3_v_control.step_pre = 0;

    bp3_control_data_1.bp3_v_control.para_ob.state1 = 0.0;
    bp3_control_data_1.bp3_v_control.para_ob.state2 = 0.0;
    bp3_control_data_1.bp3_v_control.para_ob.enable = 0;
    double theta = get_encoder_pos();
    bp3_control_data_1.bp3_v_control.theta_rm_est = 1.0*theta + PI2;
    //bp3_control_data_1.bp3_v_control.theta_rm_est = PI2;
    reset_states_3phase(&(bp3_control_data_1.bp3_v_control.para_ob.para_PI.state_1));

    bp3_control_data_1.current_control = init_currentloop();
    bp3_control_data_1.current_control->sel_config = InvFour;
    reset_regulator();
    bp3_control_data_1.is_init = 1;

    bp3_control_data_1.BP3_PARA = BP3_PARA_1;


    injection_ctx_clear(&inj_ctx_ctrl_bp3);

    bp3_control_data_1.bp3_lev_control.delta_ref[0] = 0.0;
    bp3_control_data_1.bp3_lev_control.delta_ref[1] = 0.0;

    reset_states_3phase(&(bp3_control_data_1.bp3_lev_control.Ixy0_ref[0]));

    bp3_control_data_1.bp3_v_control.wrm_ref = 0.0;
    reset_states_3phase(&(bp3_control_data_1.bp3_v_control.Idq0_ref[0]));
    bp3_control_data_1.bp3_v_control.Idq0_ref[0] = 1.0;
    bp3_get_deltaxy_mes(&bp3_control_data_1);
    bp3_control_data_1.bp3_lev_control.delta_ref[0] = bp3_control_data_1.bp3_lev_control.delta_mes[0]*0.95;
    bp3_control_data_1.bp3_lev_control.delta_ref[1] = bp3_control_data_1.bp3_lev_control.delta_mes[1]*0.95;

    bp3_control_data_1.bp3_lev_control.para_levi_control.para_lpf.state_1[0] = bp3_control_data_1.bp3_lev_control.delta_mes[0]*0.95;
    bp3_control_data_1.bp3_lev_control.para_levi_control.para_lpf.state_1[1] = bp3_control_data_1.bp3_lev_control.delta_mes[1]*0.95;
    bp3_control_data_1.bp3_lev_control.para_levi_control.para_delta_lpf.state_1[0] = bp3_control_data_1.bp3_lev_control.delta_ref[0];
    bp3_control_data_1.bp3_lev_control.para_levi_control.para_delta_lpf.state_1[1] = bp3_control_data_1.bp3_lev_control.delta_ref[1];

    bp3_control_data_1.bp3_lev_control.F_xy[0] = 0.0;
    bp3_control_data_1.bp3_lev_control.F_xy[1] = 0.0;

    bp3_control_data_1.bp3_v_control.enable_encoder = 0;
...
void bm_start_theta(bp3_control* data){
    ...
    if (pwm_is_enabled()){
    	if (!data->bp3_v_control.enable_encoder){
			...
			data->bp3_v_control.theta_rm_mes_offset = get_encoder_pos();
			double theta = get_encoder_pos();
			data->bp3_v_control.theta_re_ref = 1.0*(theta - data->bp3_v_control.theta_rm_mes_offset)*data->BP3_PARA_1->para_machine.p;
...
void bp3_controlloop_1 (bp3_control* data)
{
   ...
   // transfer commands to current loop
   data->current_control->tq2.we = data->bp3_v_control.wre_ref;
   data->current_control->tq2.theta_rad = data->bp3_v_control.theta_re_ref;
   data->current_control->tq2.Idq0_ref[0] = data->bp3_v_control.Idq0_ref[0];
   data->current_control->tq2.Idq0_ref[1] = data->bp3_v_control.Idq0_ref[1];
   data->current_control->tq2.Idq0_ref[2] = data->bp3_v_control.Idq0_ref[2];

   data->current_control->s2.we = data->bp3_v_control.wre_ref*(-1.0);
   data->current_control->s2.theta_rad = data->bp3_v_control.theta_re_ref*(-1.0); //data->BP3_PARA->para_machine.kf_theta_rad;
   data->current_control->s2.Idq0_ref[0] = data->bp3_lev_control.Ixy0_ref[0];
   data->current_control->s2.Idq0_ref[1] = data->bp3_lev_control.Ixy0_ref[1];
   data->current_control->s2.Idq0_ref[2] = data->bp3_lev_control.Ixy0_ref[2];
