...
static para_bim BIM_PARA = {
	...
	.para_machine.theta_offset_xy = -PI/24.0,
	.para_machine.p = 1,
	.para_machine.ps = 2,
	...
	.para_machine.m_rotor = 1.488*0.0 + 1.0,
	...
	.para_control.v_pi_Kp = 0.2,
	.para_control.v_pi_Ki= 0.0,
	.para_control.v_lpf_f= 0.5,
	.para_control.lev_pi_Kp= 0.0,
	.para_control.lev_pi_Ki= 0.0,
	.para_control.lev_lpf_f= 150.0,
...
void update_para_bim_activedamping(para_bim *data, double id){
	...
	data->para_control.lev_ba = 2.0*w_bw*data->para_machine.m_rotor*1.5;
