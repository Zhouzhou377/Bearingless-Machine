...
void bp3_injection_callback (bp3_control *data){
	...
	injection_inj(&(data->bp3_v_control.wrm_ref_inject), &inj_ctx_ctrl[8], data->bp3_v_control.Ts);

	injection_inj(&(data->bp3_lev_control.F_xy_inject[0]), &inj_ctx_ctrl[9], data->bp3_v_control.Ts);
	injection_inj(&(data->bp3_lev_control.F_xy_inject[1]), &inj_ctx_ctrl[10], data->bp3_v_control.Ts);
